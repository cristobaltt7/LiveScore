            ...
            <form method="POST" action="{{ route('profile.update') }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" class="form-control bg-secondary text-white border-0" value="{{ old('name', auth()->user()->name) }}" required>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Email</label>
                        <input type="email" name="email" class="form-control bg-secondary text-white border-0" value="{{ old('email', auth()->user()->email) }}" required>
                    </div>
                </div>
...
@endif
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" name="current_password" class="form-control bg-secondary text-white border-0" required>
                </div>
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary w-100"><i class="bi bi-key"></i> Cambiar contraseña</button>
            </form>
        </div>
    </div>
            ...
            <form method="POST" action="{{ route('profile.destroy') }}">
                ...
                <div class="modal-content bg-dark text-white">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="password" name="password" class="form-control mt-2 bg-secondary text-white border-0" required>
                    </div>
...
<script>
  ...
  function doTranslate(select) {
    ...
    if (!iframe) return alert("Espera unos segundos a que cargue el traductor.");
